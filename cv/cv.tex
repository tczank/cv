...
\usepackage{tabularx}
\usepackage [brazilian, english, japanese]{babel}     % nomes e hifenaçã em português
\usepackage{CJKutf8}
...
\begin{flushright}
\hspace*{-2cm}
%%% Foto de Nagareyama vc de barba e camiseta
% \includegraphics[scale=2.]{/home/tczank/Dropbox/job_app/niigatadai/rireki/3x4_3.png}
%%% foto de 8mb nao aceita pelo indeed
%\includegraphics[angle=90, scale=.02]{/home/tczank/Imagens/portaretratoprof.jpg}
\includegraphics[angle=90, scale=.2]{/home/tczank/Imagens/hdprofessor.jpg}
\end{flushright}
\end{minipage}
